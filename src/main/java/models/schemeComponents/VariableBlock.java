 ...
 */
public final class VariableBlock extends LogicComponent {
    ...
    private void bindSocket() {
        if (position == Position.Source) {
            ...
            connectionSockets.get(0).centerYProperty().bind(body.layoutYProperty().add(body.getHeight() / 2));
    ...
    //@Override
    public void addGraphElemsOnWorkspace(Pane workspace, boolean tool) {
